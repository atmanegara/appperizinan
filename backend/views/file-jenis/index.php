...
$this->title = 'Jenis File';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="ejafung-file-jenis-index">
<div class="panel">
    <div class="panel-body">

        <div class="pull-right">
            <p>
                <?= Html::a('New Jenis File', ['#file-jenis/create'], ['class' => 'btn btn-success']) ?>
            </p>
        </div>
    <?= GridView::widget([
