...
class AppAsset extends AssetBundle {
   ...
   'cadmin/plugins/pace/pace.min.js',
        ...
        'cadmin/plugins/flot/jquery.flot.min.js',
        'cadmin/plugins/flot/jquery.flot.time.min.js',
        'cadmin/plugins/flot/jquery.flot.resize.min.js',
        'cadmin/plugins/flot/jquery.flot.pie.min.js',
